...
SEXP savvy_VectorStyle_set_outline__ffi(SEXP self__, SEXP c_arg__color, SEXP c_arg__width);
SEXP savvy_VectorStyle_set_stroke_target__ffi(SEXP self__, SEXP c_arg__fill_color);
